...
<div id="content">
    ...
    <!--<h1>FAMILY FIRST: HOW TO BE A HERO AT HOME<BR> 9 STRATEGIES FOR THE SUCCESSFUL FAMILY MAN</h1>-->
    <img src="wp-content/themes/familyfirstbook/assets/images/Family_First_Book_Cover.png" />

    <div class="share-book">
    <a href="http://www.facebook.com/share.php?u=http://familyfirstbook.com/&amp;t=Family First: How to Be a Hero at Home" onclick="javascript:window.open(this.href,
...
<a href="http://twitter.com/home?status=Family First: How to Be a Hero at Home - http://familyfirstbook.com/" onclick="javascript:window.open(this.href,
'', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');return false;" class="twitter"><i class="fa fa-twitter"></i></a>
<a href="javascript:pinIt();" class="pinterest"><i class="fa fa-pinterest"></i></a>
